...
EXTRACTION_PROVIDERS = [
    {
        ...
        "description": "NVIDIA NIM Step 3.5 Flash",
    },
    {
        "name": "groq",
...
class ClaimExtractor:
    """
    Extracts verifiable claims from AI responses using an OpenAI-compatible provider.

    Priority order: NVIDIA NIM > Groq > OpenRouter.
    """
